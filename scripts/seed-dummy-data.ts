  ...
  contentSections: [
    {
      ...
      description: 'Each product tells a story of tradition, craftsmanship, and passion. From wooden furniture to handwoven textiles, every item is created with care and attention to detail.',
      image: null,
      imagePosition: 'right',
      primaryCta: {
        text: 'Shop Now',
      ...
      testimonials: [
        {
          _key: 'testimonial-1',
          type: 'text',
          quote: 'The quality of craftsmanship is absolutely incredible. I can feel the love and care that went into making this piece.',
          name: 'Sarah Johnson',
        ...
        },
        {
          _key: 'testimonial-2',
          type: 'text',
          quote: 'Every piece tells a story. I love knowing that my purchase supports traditional artisans and their families.',
          name: 'Michael Chen',
          source: 'Verified Customer',
          image: null
        },
        {
          _key: 'testimonial-3',
          type: 'press',
          pressQuote: 'HoliCraft represents the perfect blend of traditional craftsmanship and modern design.',
  ...
  categorySections: [
    {
      ...
      description: 'Find the perfect handcrafted piece for your home and lifestyle.',
      categories: [
        {
          _key: 'furniture',
          label: 'Furniture',
  ...
  imageSections: [
    {
      ...
      description: 'Watch our master craftsmen at work, creating beautiful pieces that will last for generations.',
      imagePosition: 'left',
      alignment: 'left',
  ...
  layoutSections: [
    {
      ...
      description: 'Learn about our journey and the artisans behind our products.',
      columns: 2,
      gap: 'gap-8',
      alignment: 'center',
      backgroundColor: '#FFFFFF',
      ...
      columns: [
        {
          ...
          links: [
            ...
            { label: 'New Arrivals', url: '/collections/new-arrivals', external: false },
            { label: 'Best Sellers', url: '/collections/best-sellers', external: false },
        ...
        },
        {
          ...
          links: [
            ...
            { label: 'Sustainability', url: '/sustainability', external: false }
          ]
        },
        {
          heading: 'Support',
  ...
  homepages: [
    {
      ...
      sections: [
        {
          ...
          heroTitle: 'Handcrafted with Love',
          subheading: 'Discover unique pieces made by skilled artisans',
          description: 'Each product tells a story of tradition, craftsmanship, and passion.',
          image: null,
          imagePosition: 'right',
          primaryCta: {
            text: 'Shop Now',
          ...
          socialProofImages: [
            {
              ...
              description: 'Join our community of satisfied customers who love handcrafted quality.',
              link: '/testimonials'
            },
            {
              _key: 'social-proof-2',
              ...
              description: 'Thousands of 5-star reviews from happy customers worldwide.',
              link: '/reviews'
            }
          ]
        }
      ...
      seo: {
        ...
        description: 'Discover unique handcrafted products made by skilled artisans. From furniture to jewelry, each piece tells a story of tradition and craftsmanship.',
        ogImage: null
      }
    }
  ]
